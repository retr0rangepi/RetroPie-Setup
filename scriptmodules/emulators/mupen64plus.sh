...
function depends_mupen64plus() {
    local depends=(cmake libsamplerate0-dev libspeexdsp-dev libpng-dev libfreetype6-dev fonts-freefont-ttf libboost-filesystem-dev)
...
function configure_mupen64plus() {
    ...
    if isPlatform "rpi"; then
        ...
        addEmulator 0 "${md_id}-rice" "n64" "$md_inst/bin/mupen64plus.sh mupen64plus-video-rice %ROM%"
