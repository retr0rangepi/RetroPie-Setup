...
rp_module_desc="AdvanceMAME v3.6"
...
function sources_advmame() {
    downloadAndExtract "https://github.com/amadvance/advancemame/releases/download/v3.6/advancemame-3.6.tar.gz" "$md_build" 1
}
